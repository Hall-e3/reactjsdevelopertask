      ...
      <section className="py-20">
        <div className="flex flex-row gap-3">
          <div className="w-full h-full ">
            <Avatar src="/images/Enoch.jpeg" alt="avatar" height={100} width={100} />
          </div>
          <div className="flex flex-col justify-center px-6 space-y-2">
            ...
            <p className="text-[13px] sm:text-[15px]">We're a nonprofit with the mission to provide a free, world-class education for anyone, anywhere.</p>
            <div>
